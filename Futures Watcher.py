        ...
        while True:
            ...
            if should_run_BU:
                ...
                if should_run_BU:
                        ...
                        for mm in range (len(BnFAcc)):
                            ...
                            if len(BnFAcc1)>0:
                                ...
                                if TP_CC > 0:
                                    for nn in range(1,TP_CC+1):
                                        ...
                                        if TP_It[1] == str(BnFAcc1['symbol']) and TP_It[0] == str(BnFAcc1['positionSide']):
                                            app.Tree_Ord.item(nn, values=(str(BnFAcc1['positionSide']),str(BnFAcc1['symbol']),str(BnFAcc1['leverage']), str(BnFAcc1['unRealizedProfit']),str(BnFAcc1['isolatedMargin']),str(BnFAcc1['entryPrice']),
                                                                                                    str(float(BnFAcc1['positionAmt'])),str(float(BnFAcc1['positionAmt'])*float(BnFAcc1['entryPrice'])),
                                                                                                    str(float(BnFAcc1['positionAmt'])*float(BnFAcc1['entryPrice'])*float(BnFAcc1['leverage'])),str(BnFAcc1['liquidationPrice'])))
                                            TP_SCh = False
                                            #print(TP_It[0])
                                ...
                                if TP_SCh == True and float(BnFAcc1['positionAmt']) != 0:
                                    ...
                                    app.Tree_Ord.insert(parent='',index='end',iid=l,text='',values=(str(BnFAcc1['positionSide']),str(BnFAcc1['symbol']),str(BnFAcc1['leverage']), str(BnFAcc1['unRealizedProfit']),str(BnFAcc1['isolatedMargin']),str(BnFAcc1['entryPrice']),
                                                                                                    str(float(BnFAcc1['positionAmt'])),str(float(BnFAcc1['positionAmt'])*float(BnFAcc1['entryPrice'])),
                                                                                                    str(float(BnFAcc1['positionAmt'])*float(BnFAcc1['entryPrice'])*float(BnFAcc1['leverage'])),str(BnFAcc1['liquidationPrice'])))
                                    l +=1
                    ...
                    for nn in range(1,TP_CC+1):
                        TP_It = app.Tree_Ord.item(nn)["values"]
                        if float(TP_It[5]) == 0 and float(TP_It[6]) == 0 and kk<=len(TP_Tpl_Tmp):
                            nm=True
                            km=False
                            for mm in range(kk,len(TP_Tpl_Tmp)):
                                #print(mm)
                                if float(TP_Tpl_Tmp[mm][3])!=0 and float(TP_Tpl_Tmp[mm][4])!=0 and km==False:
                                    app.Tree_Ord.item(nn, values=(TP_Tpl_Tmp[mm][0],TP_Tpl_Tmp[mm][1],TP_Tpl_Tmp[mm][2],TP_Tpl_Tmp[mm][3],TP_Tpl_Tmp[mm][4],TP_Tpl_Tmp[mm][5],TP_Tpl_Tmp[mm][6],TP_Tpl_Tmp[mm][7],TP_Tpl_Tmp[mm][8],TP_Tpl_Tmp[mm][9]))
                                    kk=mm+1
                                    #print(nn,kk,mm)
                                    km=True
                            ...
                            if nm==True and kk<TP_CC:
                                app.Tree_Ord.item(nn, values=(TP_Tpl_Tmp[kk][0],TP_Tpl_Tmp[kk][1],TP_Tpl_Tmp[kk][2],TP_Tpl_Tmp[kk][3],TP_Tpl_Tmp[kk][4],TP_Tpl_Tmp[kk][5],TP_Tpl_Tmp[mm][6],TP_Tpl_Tmp[mm][7],TP_Tpl_Tmp[mm][8],TP_Tpl_Tmp[mm][9]))
                            kk +=1
