...
class Binance():
    ...
    methods = {
            ...
            'futuresAccount':       {'url': 'fapi/v1/account', 'method': 'GET', 'private': True, 'futures': True},
            'futuresBalance':       {'url': 'fapi/v1/balance', 'method': 'GET', 'private': True, 'futures': True},
            'userPositionInfo':     {'url': 'fapi/v2/positionRisk', 'method': 'GET', 'private': True, 'futures': True}
    }
    ...
    def call_api(self, **kwargs):
        ...
        if self.methods[command]['private']:
            ...
            payload.update({'recvWindow': '60000'})
